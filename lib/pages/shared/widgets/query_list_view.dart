...
class FirestoreListView<Document> extends FirestoreQueryBuilder<Document> {
  FirestoreListView({
    ...
    pageSize: pageSize,
    builder: (context, snapshot, _) {
      loadingBuilder ??= (context) => const SpinKitWaveSpinner(
      ...
      errorBuilder ??= (context, error, stackTrace) {
        ...
        Snack.show(message: error.toString(), type: SnackBarType.error);
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (extraItem != null && index == itemCount - 1){
            return extraItem;
          }

          final doc = snapshot.docs[index];
          return itemBuilder(context, doc, index, itemCount);
        },
